...
- [Product Manager Prompts or Generative AI](https://github.com/deanpeters/product-manager-prompts): Open-source prompts built on well-known, often-practiced product manager tools, techniques, and templates.
